                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    ...
                    <li>
                        <input type="text" placeholder="Hint #"
                            class="px-5 py-1.5 bg-transparent border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm text-sm text-[#1b1b18] dark:text-[#EDEDEC] placeholder:text-[#706f6c] dark:placeholder:text-[#A1A09A]" />
                    </li>
                </ul>
            </div>
            <div
